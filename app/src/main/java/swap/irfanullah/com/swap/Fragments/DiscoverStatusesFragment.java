...
import swap.irfanullah.com.swap.Adapters.DiscoverStatusAdapter;
...
public class DiscoverStatusesFragment extends Fragment {
    ...
    private DiscoverStatusAdapter statusAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getContext();
        makeRequest();
        statusAdapter= new DiscoverStatusAdapter(getActivity(),statuses);
