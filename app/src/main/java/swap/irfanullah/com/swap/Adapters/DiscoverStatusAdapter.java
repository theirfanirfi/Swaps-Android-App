...
public class DiscoverStatusAdapter extends RecyclerView.Adapter<DiscoverStatusAdapter.StatusViewHolder> {
    private Context context;
    private ArrayList<Status> statuses;
    private ArrayList<String> attachmentsArrayList;
    private User user;
    int STATUS_ID;
    public DiscoverStatusAdapter(Context context, ArrayList<Status> st) {
